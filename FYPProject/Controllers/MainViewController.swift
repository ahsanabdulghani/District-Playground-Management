...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = #colorLiteral(red: 0.202774018, green: 0.2273907065, blue: 0.2517824769, alpha: 1)
        // Navigation Bar Appearance
        self.setNavBarAppearance(tintColor: .white, barColor: UIColor(#colorLiteral(red: 0.202774018, green: 0.2273907065, blue: 0.2517824769, alpha: 1)))
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            ...
            self.showViewController(viewController: AddGroundDetailViewController.self, storyboardId: "Addgrounddetailpage")
            
            
        case 2:
            // Movies
            self.showViewController(viewController: ManageGroundViewController.self, storyboardId: "managegroundpage")
        case 3:
            // Books
//            self.showViewController(viewController: BooksViewController.self, storyboardId: "BooksVCID")
            self.showViewController(viewController: AddMembershipDetailViewController.self, storyboardId: "addmembershipdetailpage")
...
//            present(profileModalVC!, animated: true, completion: nil)
            self.showViewController(viewController: BookingViewController.self, storyboardId: "bookingviewpage")
            
        case 5:
            // Settings
            self.showViewController(viewController: EarningViewController.self, storyboardId: "earningviewpage")
        case 6:
            // Like us on facebook
            self.showViewController(viewController: HomeViewController.self, storyboardId: "displayhomeviewpage")
        default:
            break
        }
